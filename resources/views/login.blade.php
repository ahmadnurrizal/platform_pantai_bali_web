            ...
            <div class="m-auto">
                <div class="grid gap-2 w-[355px]">
                    ...
                    <div class="flex justify-between">
                        ...
                        <a href="" class="font-normal text-base text-green-600 justify-end hover:text-green-800">Forgot password?</a>
                    </div>
                    <button class="rounded text-white bg-cyan-600 w-full py-3 mt-7 hover:bg-cyan-700">Login now</button>
                    <p class="flex justify-center text-gray-500 font-normal pt-5">Dont have an account? &nbsp;<a href="/register" class="font-normal text-base text-blue-400 justify-end hover:text-blue-500">Register Now</a></p>
                </div>
            </div>
        </div>
    </div>
